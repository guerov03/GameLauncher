...
;--------------------------------------------------------------------------
; Stand Medium Punch
[State -1, Water Prision]
type = ChangeState
value = 2020
triggerall = command = "pri"
...
;--------------------------------------------------------------------------
; Stand Medium Punch
[State -1, Big Fucking Wave Of Doom]
type = ChangeState
value = 2030
triggerall = command = "bfw"
triggerall = !ishelper(15000)
...
;---------------------------------------------------------------------------
; Stand Medium Punch
[State -1, Ninpuo Kirigakure No Jutsu]
type = ChangeState
value = 2000
triggerall = var(20) = 0
triggerall = !ishelper(15000)
triggerall = power >= 1000
triggerall = command = "mist"
trigger1 = statetype = S | statetype = C
trigger1 = ctrl
trigger2 = stateno = 200 && animelemtime(4)>0
trigger3 = stateno = 210 && animelemtime(3)>0
...
;---------------------------------------------------------------------------
; Stand Light Punch
[State -1, Assasin Teleport No Jutsu]
type = ChangeState
...
trigger3 = stateno = 210 && animelemtime(3)>0
trigger4 = stateno = 200 && animelemtime(4)>0
;---------------------------------------------------------------------------
; Stand Medium Punch
...
;---------------------------------------------------------------------------
; Stand Medium Punch
[State -1, Crouch Heavy Sword attack]
type = ChangeState
value = 420
triggerall = var(20) = 0
triggerall = command = "z"
...
;---------------------------------------------------------------------------
; Stand Medium Punch
[State -1, Air Heavy Sword attack]
type = ChangeState
value = 620
triggerall = var(20) = 0
triggerall = command = "z"
...
value = 630
triggerall = var(20) = 0
triggerall = command="a"||command="b"||command="x"||command="y"||command="c"
trigger1 = statetype = A
trigger1 = ctrl
...
trigger1 = ctrl = 1
trigger2 = animelemtime(4)>0 && stateno = 240
value = 250
;----------------------------------------------------------------------------
;heavy punch
[State -1, AI Assin tele]
type = ChangeState
triggerall = ctrl = 1
triggerall = var(20) = 1
triggerall = StateType != A
...
;---------------------------------------------------------------------------
; Stand Medium Punch
[State -1, AI Ninpuo Kirigakure No Jutsu]
type = ChangeState
value = 2000
triggerall = power >= 1000
triggerall = !ishelper(15000)
...
[State -1, Bunshin stuff 0]
type = PlayerPush
trigger1 = 1 && Ishelper(15000)
value = 1

[State -1, Bunshin stuff 1]
type = AssertSpecial
trigger1 = 1 && Ishelper(15000)
flag = nostandguard
flag2 = nocrouchguard
...
[State -1, Bunshin stuff 3]
type = VarSet
trigger1 = 1 && ishelper(15000)
v = 20   ;fv = 10
value = 1

[State -1, Bunshin stuff 4]
type = ScreenBound
trigger1 = 1 && ishelper(15000)
value = 1
movecamera = 1,1

[State -1, Bunshin stuff 5]
type = Turn
trigger1 = p2dist x < -30 && ishelper(15000) && ctrl = 1

[State -1, Bunshin stuff 6]
type = AttackMulSet
triggerall = ishelper(15000)
