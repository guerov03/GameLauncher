...
[Command]
name = "hiddensp"
command = b+y ;~D, DB, B, D, DB, B, a
time = 20

[Command]
name = "hiddensp"   ;Same name as above
command = b+y ;~D, DB, B, D, DB, B, b
time = 20
...
;--------------------------------------------------------------------------
; This is a backup from state -3, in case the activation fail.
; Humanly-Impossible Commands method
[State -1, TurnBackOnAI]
type = VarSet
...
type = ChangeState
value = 40
triggerall = var(58) = 1 && palno <= 6 && p2statetype != L && statetype != A && P2Life != 0 && stateno != 40 && anim != 40 && stateno != 0 && anim != 0 && stateno != 10 && anim != 10 && var(7) != 1 && ctrl 
...
value = 100
triggerall = var(58) = 1
triggerall = p2bodydist x > 40 && p2movetype != A && random <= 100
...
trigger1 = p2statetype = L && random <= 3
trigger2 = p2movetype = I && random <= 3
trigger3 = p2movetype != H && random <= 3
trigger4 = p2movetype != A && random <= 3
trigger5 = random <= 3
...
[State -1, 200]
type = ChangeState
value = ifelse(random <=500,200,200)
...
value = 1100
triggerall = var(58) = 1 && palno <= 6 && p2statetype != L && statetype != A && P2Life != 0 && var(7) != 1 && ctrl
trigger1 = (p2bodydist x >= 100) && random = (601,700)
trigger2 = random = (701,750)

; anti-teleport
[State -1, 1400]
type = ChangeState
value = ifelse(random <= 500,200,1400)
triggerall = var(58) = 1 && palno <= 6 && p2statetype != L && statetype != A && P2Life != 0 && var(7) != 1 && ctrl
trigger1 = (p2bodydist x <= 50) && p2statetype = A && random <= 50
trigger2 = (p2bodydist x <= 50) && p2stateno = 5050
...
trigger1 = (p2bodydist x >= 150) && random = (801,900)
trigger2 = enemy,numproj = 1 
trigger3 = random = (901,950)
...
type = ChangeState
value = 1450
triggerall = var(58) = 1 && palno <= 6 && p2statetype != L && statetype != A && P2Life != 0 && power > 1000 && var(11) = 0 && var(7) != 1 && ctrl 
trigger1 = (p2bodydist x >= 100) && p2movetype = A && random <= 800
trigger2 = p2movetype = A && random <= 800
trigger3 = power > 2000 && random <= 100
trigger4 = power = 3000 && random <= 100
trigger5 = random = (951,999)
...
type = ChangeState
value = 2600
triggerall = var(58) = 1 && palno <= 6 && p2statetype != L && statetype != A && P2Life != 0 && power >= 1000 && var(5) = 0 && var(7) != 1 && ctrl
...
type = ChangeState
value = 2000
triggerall = var(58) = 1 && palno <= 6 && p2statetype != L && statetype != A && P2Life != 0 && power >= 1000 && var(7) != 1 && ctrl
trigger1 = (p2bodydist x >= 100) && random <= 50
trigger2 = random <= 50

; Makyou No Ran AI commands.
; demon 1 behind player
[State -1, 2650]
type = ChangeState
value = 2650
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2615) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x <= 100) && random <= 50
trigger2 = random <= 3

; demon 1 behind enemy
[State -1, 2200]
type = ChangeState
value = 2200
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2615) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
...
; demon 2 front of player
[State -1, 2660]
type = ChangeState
value = 2660
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2630) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x <= 100) && random <= 50
trigger2 = random <= 3
trigger3 = enemy,numproj = 1 && random <= 100

; demon 2 behind enemy
[State -1, 2220]
type = ChangeState
value = 2220
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2630) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
...
; demon 3 behind player
[State -1, 2670]
type = ChangeState
value = 2670
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2675) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x >= 100) && random <= 50
trigger2 = random <= 3

; demon 3 behind enemy
[State -1, 2230]
type = ChangeState
value = 2230
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2675) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
...
; demons behind player
[State -1, 2680]
type = ChangeState
value = 2680
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2615) = 0 && NumHelper(2630) = 0 && NumHelper(2675) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x <= 100) && random <= 50
trigger2 = random <= 3
...
value = 2240
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2615) = 0 && NumHelper(2630) = 0 && NumHelper(2675) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x >= 180) && random <= 50
trigger2 = random <= 3

; demons summon snakes
[State -1, 2690]
type = ChangeState
value = 2690
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2695) = 0 && var(6) = 0 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
...
type = ChangeState
value = 2250
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2690) = 0 && NumProjID(4000) = 0 && var(6) = 1 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x >= 150) && p2statetype = L && random <= 25
trigger2 = random <= 3
...
value = 2700
triggerall = var(58) = 1 && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2690) = 0 && NumProjID(4000) = 0 && var(6) = 1 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x < 150) && p2statetype = L
trigger2 = random <= 3

; Sound Party
[State -1, 2900]
type = ChangeState
value = ifelse(random <= 500,2100,2900)
triggerall = var(58) = 1 && palno <= 6 && var(9) = 1 && var(11) = 1 && var(7) != 1 && life <= 250 &&  statetype != A && P2Life != 0 && ctrl
...
type = ChangeState
value = 2800
triggerall = var(58) = 1 && palno <= 6 && var(7) = 0 && var(11) = 1 && life <= 250 && statetype != A && ctrl
...
trigger1 = (p2bodydist x > 60) && random <= 50 && var(11) = 1 
trigger2 = (p2bodydist x > 60) && random <= 50 && power >= 1000
...
value = 3200
triggerall = var(58) = 1 && palno > 6 && var(9) = 1 && var(11) = 1 && var(7) != 1 && life <= 250 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x < 180) && p2statetype = S && random <= 800
trigger2 = random <= 100
...
type = ChangeState
value = ifelse(random <= 200,3300,3200)
triggerall = var(58) = 1 && palno > 6 && var(9) = 1 && var(11) = 1 && var(7) != 1 && P2Life != 0 &&  p2statetype != L && statetype != A && NumHelper(3350) = 0 && ctrl
trigger1 = (p2bodydist x > 60) && (p2bodydist x < 300) && p2stateno = 5001 
trigger2 = random > 800 
trigger3 = stateno = 1600 && animelemtime(14) > 0 && movecontact 
trigger4 = (p2bodydist x > 40) && (p2bodydist x < 300) && p2stateno = 5120 && random <= 500
...
type = ChangeState
value = 1500
triggerall = var(58) = 1 && power >= 200 && palno > 6 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl 
trigger1 = enemy, numproj = 1 && random <= 100
trigger2 = enemy, numproj > 1 && random <= 100
...
value = 1700
triggerall = var(58) = 1 && palno > 6 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x < 60) && p2statetype = A && random <= 50
trigger2 = (p2bodydist x < 60) && p2statetype = S && random <= 50
...
type = ChangeState
value = 1800
triggerall = var(58) = 1 && palno > 6 && var(7) != 1 && statetype = A && stateno != 1800 && stateno != 1850 && anim != 44 && anim != 45 && P2Life != 0 && ctrl 
trigger1 = BackEdgeDist < 10 && ScreenPos Y = [0,200]
...
value = 1900
triggerall = var(58) = 1 && palno > 6 && var(7) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x > 10) && random <= 50
trigger2 = random <= 50
...
type = ChangeState
value = 1950
triggerall = var(58) = 1 && palno > 6 && var(7) != 1 && power >= 1000 && var(10) != 1 && var(11) != 1 && var(12) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = random <= 50
...
type = ChangeState
value = 201
triggerall = var(58) = 1 && palno > 6 && var(7) != 1 && statetype = S && P2Life != 0 && ctrl
...
;---------------------------------------------------------------------------
;              A I  C U R S E  S E A L  F O R M  C O D E  2 8 0 0  
;---------------------------------------------------------------------------
...
type = ChangeState
value = 3000
triggerall = var(58) = 1 && var(7) = 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x > 60) && random <= 50 && var(11) = 1 
trigger2 = (p2bodydist x > 60) && random <= 50 && power >= 1000
...
type = ChangeState
value = 3100
triggerall = var(58) = 1 && var(11) = 1 && var(7) = 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = (p2bodydist x > 60) && random <= 50
...
type = ChangeState
value = 3200
triggerall = var(58) = 1 && var(9) = 1 && var(11) = 1 && var(7) = 1 && life <= 250 && statetype != A && P2Life != 0 && ctrl
trigger1 = random <= 800
...
type = ChangeState
value = 3300
triggerall = var(58) = 1 && var(9) = 1 && var(11) = 1 && var(7) = 1 && P2Life != 0 && statetype != A && NumHelper(3350) = 0 && ctrl
trigger1 = (p2bodydist x > 60) && (p2bodydist x < 300) && p2stateno = 5001 
trigger2 = random > 800 
trigger3 = stateno = 1600 && animelemtime(14) > 0 && movecontact 
...
type = ChangeState
value = 1500
triggerall = var(58) = 1 && power >= 200 && var(7) = 1 && statetype != A && P2Life != 0 && ctrl 
trigger1 = enemy, numproj = 1 && random <= 100
trigger2 = enemy, numproj > 1 && random <= 100
trigger3 = p2movetype = A && random <= 100
...
type = ChangeState
value = 1800
triggerall = var(58) = 1 && var(7) = 1 && statetype = A && stateno != 1800 && stateno != 1850 && anim != 44 && anim != 45 && P2Life != 0 && ctrl 
trigger1 = BackEdgeDist < 10 && ScreenPos Y = [0,200]
...
type = ChangeState
value = 1950
triggerall = var(58) = 1 && var(7) = 1 && power >= 1000 && var(10) != 1 && var(11) != 1 && var(12) != 1 && statetype != A && P2Life != 0 && ctrl
trigger1 = random <= 50
...
type = ChangeState
value = 201
triggerall = var(58) = 1 && var(7) = 1 && statetype = S && P2Life != 0 && ctrl
trigger1 = (p2bodydist x < 10) && p2statetype = S

[State -1, 441]
type = ChangeState
value = 211
triggerall = var(58) = 1 && var(7) = 1
trigger1 = stateno = 201 && movecontact
...
type = ChangeState
value = 2240
triggerall = command = "helper4" && command != "c" && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2615) = 0 && NumHelper(2630) = 0 && NumHelper(2675) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1 
trigger1 = statetype != A && ctrl
...
type = ChangeState
value = 2680
triggerall = command = "demon4" &&  command != "c" && palno <= 6 && var(5) = 1 && NumHelper(2610) = 0 && NumHelper(2615) = 0 && NumHelper(2630) = 0 && NumHelper(2675) = 0 && NumHelper(2685) = 0 && NumHelper(2695) = 0 && var(7) != 1
trigger1 = statetype != A && ctrl
...
type = ChangeState
value = 2100
triggerall = command = "DS_special" && palno <= 6 && var(9) = 1 && var(11) = 1 && var(7) != 1 ;&& life <= 250
trigger1 = statetype != A && ctrl
...
triggerall = command = "holddown" && power >= 200 && palno <= 6 && var(7) != 1
...
type = ChangeState
value = 1300
triggerall = command = "WallStand" && palno <= 6 && var(7) != 1
...
type = ChangeState
value = 1400
triggerall = command = "antiteleport" && command != "x" && command != "y" && palno <= 6 && var(7) != 1
trigger1 = statetype != A && ctrl
...
trigger8 = stateno = 1100 && animelemtime(8) >= 0 && var(11) = 1
...
trigger2 = stateno = 1100 && animelemtime(8) >= 0 && var(11) = 1
...
trigger1 = statetype = S && ctrl
trigger2 = stateno = 1100 && animelemtime(8) >= 0 && var(11) = 1
trigger3 = stateno = 2660 && animelemtime(8) >= 0 && var(11) = 1
trigger4 = stateno = 2220 && animelemtime(8) >= 0 && var(11) = 1
trigger5 = stateno = 2200 && animelemtime(8) >= 0 && var(11) = 1
trigger6 = stateno = 2230 && animelemtime(8) >= 0 && var(11) = 1
trigger7 = stateno = 2240 && animelemtime(8) >= 0 && var(11) = 1
trigger8 = stateno = 2680 && animelemtime(8) >= 0 && var(11) = 1
trigger9 = stateno = 2670 && animelemtime(8) >= 0 && var(11) = 1
trigger10 = stateno = 2650 && animelemtime(8) >= 0 && var(11) = 1

;---------------------------------------------------------------------------
;Stand Strong Punch
;立ち強パンチ
[State -1, Stand Strong Punch]; deprecated
type = null;ChangeState
value = 210
triggerall = var(58) != 1
triggerall = palno <= 6 && var(7) != 1
...
;Stand Light Kick
;立ち弱キック
[State -1, Stand Light Kick];deprecated
type = null;ChangeState
value = 230
triggerall = var(58) != 1
triggerall = palno <= 6 && var(7) != 1
...
trigger2 = (stateno = 200) && time > 5
trigger3 = (stateno = 230) && time > 6
trigger4 = stateno = 1100 && animelemtime(8) >= 0 && var(11) = 1
trigger5 = stateno = 2660 && animelemtime(8) >= 0 && var(11) = 1
trigger6 = stateno = 2220 && animelemtime(8) >= 0 && var(11) = 1
trigger7 = stateno = 2200 && animelemtime(8) >= 0 && var(11) = 1
trigger8 = stateno = 2230 && animelemtime(8) >= 0 && var(11) = 1
trigger9 = stateno = 2240 && animelemtime(8) >= 0 && var(11) = 1
trigger10 = stateno = 2680 && animelemtime(8) >= 0 && var(11) = 1
trigger11 = stateno = 2670 && animelemtime(8) >= 0 && var(11) = 1
trigger12 = stateno = 2650 && animelemtime(8) >= 0 && var(11) = 1
...
;しゃがみ弱パンチ
[State -1, Crouching Light Punch]; Deprecated
type = null ;ChangeState
value = 400
triggerall = var(58) != 1
triggerall = palno <= 6 && var(7) != 1
...
;しゃがみ強パンチ
[State -1, Crouching Strong Punch]; Deprecated
type = null;ChangeState
value = 410
triggerall = var(58) != 1
triggerall = palno <= 6 && var(7) != 1
...
;しゃがみ弱キック
[State -1, Crouching Light Kick]; Deprecated
type = null;ChangeState
value = 430
triggerall = var(58) != 1
triggerall = palno <= 6 && var(7) != 1
...
;しゃがみ強キック
[State -1, Crouching Strong Kick]; Deprecated
type = null;ChangeState
value = 440
triggerall = var(58) != 1
triggerall = palno <= 6 && var(7) != 1
...
;---------------------------------------------------------------------------
;Jump Strong Punch
[State -1, Jump Strong Punch];deprecated
type = null;ChangeState
value = 610
triggerall = palno <= 6 && var(7) != 1
triggerall = command = "y"
...
;---------------------------------------------------------------------------
;Jump Light Kick
[State -1, Jump Light Kick];deprecated
type = null;ChangeState
value = 630
triggerall = palno <= 6 && var(7) != 1
triggerall = command = "a"
...
type = ChangeState
value = 3300
triggerall = command = "Special_Attackcs" && palno > 6 && var(9) = 1 && var(11) = 1 && var(7) != 1 && NumHelper(3350) = 0 
trigger1 = statetype != A && ctrl
...
type = ChangeState
value = 1700
triggerall = command = "antiteleportcs" && command != "y" && palno > 6 && var(7) != 1
trigger1 = statetype != A && ctrl
...
type = ChangeState
value = 3300
triggerall = command = "Special_Attackcs" && var(9) = 1 && var(11) = 1 && var(7) = 1 && NumHelper(3350) = 0
trigger1 = statetype != A && ctrl
...
value = 1500
triggerall = command = "a" || command = "b" || command = "x" || command = "y"
triggerall = command = "holddown" && power >= 200 && var(7) = 1
trigger1 = (statetype = S || statetype = C) && ctrl
...
type = ChangeState
value = 1700
triggerall = command = "antiteleportcs" && command != "y" && var(7) = 1
trigger1 = statetype != A && ctrl
