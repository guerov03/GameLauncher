...
triggerall = command != "BAIKANOJUTSU"
triggerall = command != "CHOBAIKANOJUTSU"
trigger1 = statetype = S
trigger1 = ctrl
...
trigger2 = stateno = 200
trigger2 = time >= 13
trigger3 = stateno = 250 || stateno = 350
trigger3 = time >= 15
trigger4 = stateno = 750
trigger4 = time >= 38
...
trigger1 = ctrl
trigger2 = stateno = 250 || stateno = 200
trigger2 = time >= 15
trigger3 = stateno = 450
trigger3 = time >= 12
trigger4 = stateno = 750
...
type = ChangeState
value = 700
triggerall = command = "SPIN2!" && power >= 700
triggerall = command != "holddown" && command != "holdfwd" && command != "holdback"
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = stateno = 200 || stateno = 400
...
type = ChangeState
value = 800
triggerall = command = "z" && power <= 2999
triggerall = command = "holddown" && command != "holdfwd" && command != "holdback"
trigger1 = statetype = C
trigger1 = ctrl
...
type = ChangeState
value = 1000
triggerall = command = "BAIKANOJUTSU" && power >= 1700
triggerall = command != "holddown" && command != "holdfwd" && command != "holdback"
triggerall = command != "SPIN2!"
triggerall = command != "CHOBAIKANOJUTSU"
trigger1 = statetype = S
...
type = ChangeState
value = 1200
triggerall = command = "CHOBAIKANOJUTSU" && power >= 2200
triggerall = command != "holddown" && command != "holdfwd" && command != "holdback"
triggerall = command != "SPIN2!"
triggerall = command != "BAIKANOJUTSU"
trigger1 = statetype = S
