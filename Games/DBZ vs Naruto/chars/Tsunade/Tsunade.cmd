...
; maximum 30.
[command]
name = "mega_pancade_utimatementeorte"
command = z
time = 15
...
[Command]
name = "Kunai"     ;Required (do not remove)
command = y
...
;Mega Pancade Utimatemente Forte
[State -1, Mega Pancade Utimatemente Forte]
type = ChangeState
value = 616
triggerall = command = "z"
trigger1 = (statetype = s) && ctrl
