...
trigger1 = (p2bodydist x >= 60) && p2movetype = A && var(11) != 1 && random <= 500
trigger2 = random <= 250
...
triggerall = (palno > 6 || var(7) = 1) && var(11) = 1
triggerall = command = "doton"
trigger1 = statetype = S && ctrl

;Special 2 (Ukon Hability) CS
[State -1, Ukon Hability]
type = ChangeState
value = 3100
triggerall = numhelper(3101) = 0 && numhelper(3103) = 0
triggerall = command = "Brutal_Combo"
triggerall = (palno > 6 || var(7) = 1) && var(11) = 1
trigger1 = statetype = S && ctrl
